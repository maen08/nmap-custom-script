...
4. Expected output:
   ...
   | High -- [CVSS 7.5] Strict-Transport-Security Missing
   | High -- [CVSS 7.0] Content-Security-Policy Missing
   | Medium -- [CVSS 6.0] X-Frame-Options Missing
   | Medium -- [CVSS 5.0] X-Content-Type-Options Missing
   |_Low -- [CVSS 3.0] X-XSS-Protection Missing
   ```
